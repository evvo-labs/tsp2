...
object TSPMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tsp2 = TSP2Problem.fromEuclideanPoints(parseEuclideanCoordinates(filename1), parseEuclideanCoordinates(filename2))
    ...
    islandManager.runBlocking(StopAfter(1.seconds))
